function [ix_list,ix_title] = atlas_Brainnetome_findLabelIndices_v2(tissuelabel)
...
for i = 1:length(tissuelabel)
    ...
    elseif any(func(label,{'MVOcC','LOcC'}))
        ...
        ix_cortical = [ix_cortical,i];
    elseif any(func(label,{'Amyg','Hipp'}))
        ix_mtemp = [ix_mtemp,i];
...
names = {'Cortical'; 'Subcortical'; 'Frontal'; 'Temporal'; 'Parietal'; 'Insular'; 'Cingulate'; 'Occipital';...
    'Mesial Temporal'; 'Basal Ganglia'; 'Thalamus'};
